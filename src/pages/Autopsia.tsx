...
export default function Autopsia() {
  return (
      ...
      <main className="mt-[85px] max-w-[1350px] mx-auto py-[60px] px-[5%] w-full">
        <div className="grid grid-cols-1 md:grid-cols-[340px_1fr_210px] gap-[45px]">
          ...
          <div className="col-span-1">
            <img 
              src="https://via.placeholder.com/340x500/CC0000/FFF?text=Autópsia" 
              alt="Autópsia da Personalidade"
          ...
          <div className="col-span-1">
            ...
            <div className="text-[1.15rem] text-[#333] leading-[2.1] text-justify">
              <p className="mb-[25px]">
                O que resta quando as máscaras caem? É preciso coragem para realizar uma autópsia técnica em quem você acredita ser. Este livro não é para os fracos de coração, mas para aqueles que desejam compreender as camadas mais profundas de sua própria psique.
              </p>
              ...
              <p className="mb-[25px]">
                "Autópsia da Personalidade" é uma jornada de decomposição e reconstrução. Através de análises profundas e exercícios práticos, Júlio Bhrósz guia você pela dissecação de seus padrões comportamentais, crenças limitantes e estruturas de identidade que você carrega há anos.
              </p>
              
              <p className="mb-[25px]">
                Descubra quem você realmente é, não quem você acredita ser.
              </p>
            </div>
          </div>
